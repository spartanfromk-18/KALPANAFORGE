        ...
        <footer className="w-full bg-zinc-950 border-t border-white/5 py-12 px-8 mt-20 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
                ...
                <div className="md:col-span-2 space-y-6">
                    <h4 className="text-[10px] font-black text-primary uppercase tracking-[0.3em]">Digital Network</h4>
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-4">
                        <div className="flex items-center justify-between gap-4">
                            ...
                            <button
                                ...
                                className="p-2 hover:bg-white/10 rounded-lg transition-all duration-300 text-zinc-400 hover:text-white hover:-translate-y-0.5"
                                title="Copy Link"
                            >
                        ...
                        <div className="flex flex-wrap gap-3">
                            <a
                                ...
                                className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-[#25D366]/5 border border-[#25D366]/20 rounded-full hover:bg-[#25D366]/10 hover:-translate-y-1 hover:shadow-lg hover:shadow-[#25D366]/20 hover:border-[#25D366]/50 transition-all duration-500 group"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full hover:bg-white/10 hover:-translate-y-1 hover:shadow-lg hover:shadow-white/10 hover:border-white/30 transition-all duration-500"
                            >
                ...
                <div className="flex flex-col items-end gap-6 text-right">
                    ...
                    <div className="pt-6">
                        <p className="text-[9px] font-bold text-zinc-600 uppercase tracking-widest">© 2026 KalpanaForge Elite Studio</p>
                        <p className="text-[8px] font-bold text-zinc-700 uppercase tracking-tighter">Depth Masking Processing v2.5.0-STABLE</p>
                    </div>
                </div>
            </div>
